        ...
        {connections.map((user, idx) => (
            ...
            >
                <div className="relative">
                     {/* Avatar Placeholder */}
                     <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-500 border border-slate-700 group-hover:border-cyber-accent/50 transition-colors print:bg-slate-100 print:border-slate-300">
                ...
                <div className="flex-1 min-w-0">
                    <div className="text-xs font-bold text-slate-200 group-hover:text-cyber-accent truncate print:text-black">
                        @{user.username}
                    </div>
